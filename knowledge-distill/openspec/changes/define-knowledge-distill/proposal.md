...
- Reconcile source changes from branch to leaf knowledge nodes and propagate substantive documentation changes toward the root.
...
- `project-knowledge`: Hierarchical knowledge nodes, source ownership, fingerprints, reconciliation, context paging, and merge gating.
...
- Adds a pull-request validation gate while keeping `main` free of pending reconciliation.
