...
- [ ] 2.5 Validate links between knowledge nodes and to referenced repository files.
- [ ] 2.6 Add deterministic tests for additions, removals, renames, mapping changes, ambiguity, links, and child propagation.
...
- [ ] 3.4 Add a policy-neutral checker with human-readable output, machine-readable output, and advisory or strict exit behavior.
...
- [ ] 4.3 Present consulted nodes as soft reconciliation prompts without making searches or reads deterministic check failures.
...
- [ ] 6.3 Document optional manual, warning-only, scheduled, and strict PR/CI uses without requiring a clean default branch.
